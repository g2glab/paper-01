...
Recently, a variety of graph database implementions dedicated to analyses on the property graph model have emerged.
...
\section{Conclusion}
In this work, we defined G2GML for mapping from RDF graphs to property graphs and implemented a converter based on the G2GML. We also showed an example usage of G2GML. Future works include further analysis of the converted graph data on the database engines adopting the property graph model.
